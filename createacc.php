                  ...
                  <div class="col-6" style="background-color: lavender;">
                    ...
                    class="form-control" placeholder="PhoneNo:">
                      ...
                      <input type="password" name="cp" id="cp" placeholder="confirm password"
                        class="form-control">      <input type="hidden" name="hide" id="cp" placeholder="confirm password"
                        class="form-control">
                        
                        <select class="form-select" aria-label="Default select example" required>
  <option selected required>Select your city</option>
  <?php
...
<br>
                        ...
                        onclick="return validate()" name="submit">Create account</button>
        ...
        <script>
            function validate(){
                ...
                var regPhone=/^\d{11}$/;  
                if(a.value=="" || regName.test(a.value)){
                ...
                if(d.value != e.value || d.value=="" || e.value==""||d.value < 8){
                    alert("Not equal or your password must be at least 8 character");
                    return false;
                }                    
                if(d.value < 8){
                    alert("You password at least 8 character");
                    return false;
                }
                if(b.value==""){
